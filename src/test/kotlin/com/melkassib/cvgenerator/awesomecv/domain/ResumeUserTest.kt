...
class ResumeUserTest {
    ...
    fun `create a user position field`() {
        ...
        assertThat(position, isA(UserInfoField::class.java))
    ...
    fun `create a user gitlab field`() {
        ...
        assertThat(gitlab, isA(UserInfoField::class.java))
    ...
    fun `create a user twitter field`() {
        ...
        assertThat(twitter, isA(UserInfoField::class.java))
    ...
    fun `create a user skype field`() {
        ...
        assertThat(skype, isA(UserInfoField::class.java))
    ...
    fun `create a user reddit field`() {
        ...
        assertThat(reddit, isA(UserInfoField::class.java))
    ...
    fun `create a user medium field`() {
        ...
        assertThat(medium, isA(UserInfoField::class.java))
    ...
    fun `create a user extra info field`() {
        ...
        assertThat(extraInfo, isA(UserInfoField::class.java))
    ...
    fun `create a user stackoverflow field`() {
        ...
        assertThat(stackOverFlow1, isA(UserInfoField::class.java))
        ...
        assertThat(stackOverFlow2, isA(UserInfoField::class.java))
    ...
    fun `create a user google scholar field`() {
        ...
        assertThat(googleScholar1, isA(UserInfoField::class.java))
        ...
        assertThat(googleScholar2, isA(UserInfoField::class.java))
    ...
    fun `create a user object`() {
        ...
        val user1 = UserInfo()
        val user2 = UserInfo("John")
        val user3 = UserInfo("John", "Dupont")
        val user4 = UserInfo("John",  "Dupont", personalInfo)
        ...
        assertThat(user4.personalInfo, everyItem(isA(UserInfoField::class.java)))
