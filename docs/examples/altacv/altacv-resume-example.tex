...
\cvevent{Job Title 2}{Company 2}{Oct 2023 -- Oct 2023}{Location}
\begin{itemize}
\item Item1
\end{itemize}
...
\cvevent{Job Title 3}{Company 3}{}{Location}
%--------------------------------------------------------------------------------
...
\cvskillstr{English}{Professional working proficiency}
\cvskillstr{Spanish}{Limited working proficiency}
\cvskill{German}{2.0}
%--------------------------------------------------------------------------------
